...
class V3d(
    ...
    fun normalized(): V3d = this / magnitude()
...
fun V3d.projectionZ(z: Double): V3d = V3d(this.x, this.y, z)
fun V3d.projectionY(y: Double): V3d = V3d(this.x, y, this.z)
fun V3d.projectionX(x: Double): V3d = V3d(x, this.y, this.z)
