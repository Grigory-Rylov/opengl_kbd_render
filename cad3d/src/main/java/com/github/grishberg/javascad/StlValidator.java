...
public class StlValidator {
    ...
    public static List<Facet> loadStl(byte[] data) {
        ...
        for (int i = 0; i < count && buf.remaining() >= 50; i++) {
            ...
            facets.add(new Facet(t, n, com.github.grishberg.openscad.utils.Color.GRAY));
        }
        return facets;
    }
        ...
        for (CoordK start : adj.keySet()) {
            ...
            if (cycle.size() >= 3 && cycle.size() <= 2000) {
                ...
                for (int k = 1; k < cycle.size() - 1; k++) {
                    ...
                    if (normal != null) {
                        newFacets.add(new Facet(new Triangle3d(p0, p1, p2), normal, com.github.grishberg.openscad.utils.Color.GRAY));
                    }
                }
            }
        }
