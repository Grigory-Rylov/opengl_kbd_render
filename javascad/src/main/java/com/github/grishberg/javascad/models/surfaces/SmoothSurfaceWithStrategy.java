...
public class SmoothSurfaceWithStrategy extends Atomic3dModel {
    ...
    public SmoothSurfaceWithStrategy(SurfaceStrategy strategy, double thickness) {
        this(
            strategy,
            thickness,
            EdgeType.Normal,
    ...
    public SmoothSurfaceWithStrategy(
    ...
    protected Abstract3dModel innerCloneModel() {
        return new SmoothSurfaceWithStrategy(strategy, thickness,
            frontEdgeType,
            leftEdgeType,
            backEdgeType,
            rightEdgeType
