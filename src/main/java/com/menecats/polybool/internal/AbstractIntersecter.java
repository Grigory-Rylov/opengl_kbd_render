...
public abstract class AbstractIntersecter {
    ...
    protected Segment segmentNew(Point2d start, Point2d end) {
        return new Segment(start, end);
    }

    protected Segment segmentCopy(Point2d start, Point2d end, Segment seg) {
        return new Segment(start, end, new Segment.SegmentFill(seg.myFill.above, seg.myFill.below));
    }


    private int eventCompare(boolean p1_isStart, Point2d p1_1, Point2d p1_2,
                             boolean p2_isStart, Point2d p2_1, Point2d p2_2) {
    ...
    private void eventAdd(LinkedList<IntersecterContent> ev, Point2d other_pt) {
    ...
    private void eventUpdateEnd(LinkedList<IntersecterContent> ev, Point2d end) {
    ...
    private LinkedList<IntersecterContent> eventDivide(LinkedList<IntersecterContent> ev, Point2d pt) {
    ...
    protected List<Segment> baseCalculate(boolean primaryPolyInverted, boolean secondaryPolyInverted) {
        ...
        BiFunction<LinkedList<IntersecterContent>, LinkedList<IntersecterContent>, Integer> statusCompare = (ev1, ev2) -> {
            Point2d a1 = ev1.getContent().seg.start;
            Point2d a2 = ev1.getContent().seg.end;
            Point2d b1 = ev2.getContent().seg.start;
            Point2d b2 = ev2.getContent().seg.end;
        ...
        final BiFunction<LinkedList<IntersecterContent>, LinkedList<IntersecterContent>, LinkedList<IntersecterContent>> checkIntersection = (ev1, ev2) -> {
            ...
            final Point2d a1 = seg1.start;
            final Point2d a2 = seg1.end;
            final Point2d b1 = seg2.start;
            final Point2d b2 = seg2.end;
