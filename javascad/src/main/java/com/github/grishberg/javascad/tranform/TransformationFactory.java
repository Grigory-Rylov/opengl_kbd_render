package com.github.grishberg.javascad.tranform;

import com.github.grishberg.javascad.coords.Abstract3d;
...
public final class TransformationFactory {
	...
	public static ITransformation getRotationMatrix(Angles3d angles) {
		V3d x = V3d.X.rotate(angles);
		V3d y = V3d.Y.rotate(angles);
		V3d z = V3d.Z.rotate(angles);
    ...
    public static ITransformation getMirrorMatrix(Direction direction) {
    	return getScaleMatrix(direction.getCoords().mul(-2.0).add(new V3d(1, 1, 1)));
    }
