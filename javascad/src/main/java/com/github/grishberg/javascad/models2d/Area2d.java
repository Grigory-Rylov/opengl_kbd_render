...
import com.github.grishberg.javascad.coords.EdgeCrossSolver;
import com.github.grishberg.javascad.coords2d.Coords2d;
import com.github.grishberg.javascad.coords2d.LineSegment2d;
import com.github.grishberg.javascad.enums.PointRelation;
...
import com.github.grishberg.javascad.utils.Pair;
...
public class Area2d extends AbstractCollection<Coords2d> {
	 ...
	 */
	public List<V3d> withZ(double z) {
