...
public final class DoubleUtils {
    ...
    /**
     * Compare two doubles and returns with an integer similar to {@link Double#compare}, but
	 * with regards to
     ...
     * @return an integer similar to {@link Double#compare}, but with regards to a predefined
	 * epsilon value
     */
    ...
    /**
     * <p>Create a hash value of the given double. It will satisfy the basic rule of equals and
	 * hashCode methods that if
     * two values are equals they have to have to same hash code value.</p>
     * <p>So this class's {@link #equalsEps(double, double)} method and this method satisfies
	 * this rule:
