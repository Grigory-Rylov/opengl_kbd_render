...
public class Boundaries3d {
	 ...
	 */
	public Boundaries3d(V3d minCorner, V3d maxCorner) {
	 ...
	 */
	public V3d getMinCorner() {
		return new V3d(getX().getMin(),getY().getMin(), getZ().getMin());
	}
	 ...
	 */
	public V3d getMaxCorner() {
		return new V3d(getX().getMax(),getY().getMax(), getZ().getMax());
	}
	 ...
	 */
	public Boundaries3d move(V3d delta) {
	 ...
	 * @return a new object with the calculated new boundaries
	 */
	public Boundaries3d scale(V3d delta) {
	...
	public Boundaries3d rotate(Angles3d angle) {
		V3d minCorner = getMinCorner();
		V3d maxCorner = getMaxCorner();
	 ...
	 */
	public V3d getAlignedValue(Side side) {
		return new V3d(
