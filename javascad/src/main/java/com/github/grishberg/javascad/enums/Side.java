package com.github.grishberg.javascad.enums;

import static com.github.grishberg.javascad.enums.AlignType.MAX_IN;
import static com.github.grishberg.javascad.enums.AlignType.MAX_OUT;
import static com.github.grishberg.javascad.enums.AlignType.MIN_IN;
import static com.github.grishberg.javascad.enums.AlignType.MIN_OUT;
...
public class Side {
	 ...
	 */
	@Deprecated
	public V3d calculateCoords(Boundaries3d model, Boundaries3d relateTo, boolean inside) {
		return new V3d(
	 ...
	 * @return the coordinates we should use in a move operation
	 */
	public V3d calculateCoords(Boundaries3d model, Boundaries3d relateTo) {
		return new V3d(
	 ...
	 * @return the coordinates we should use in a move operation
	 */
	public V3d calculateCoords(Boundaries3d model, V3d relateTo) {
		return new V3d(
				alignX.calculateCoordinate(model.getX(), relateTo.getX()),
				alignY.calculateCoordinate(model.getY(), relateTo.getY()),
				alignZ.calculateCoordinate(model.getZ(), relateTo.getZ()));
