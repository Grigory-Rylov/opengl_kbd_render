...
public class Color {
    ...
    public static final Color DARK_RED = darkRed;
    ...
    public static final Color DARK_GOLDEN_ROD = darkGoldenRod;
    public static final Color goldenRod = new Color(218, 165, 32);
    public static final Color GOLDEN_ROD = goldenRod;
    public static final Color paleGoldenRod = new Color(238, 232, 170);
    public static final Color PALE_GOLDEN_ROD = paleGoldenRod;
    public static final Color darkKhaki = new Color(189, 183, 107);
    public static final Color DARK_KHAKI = darkKhaki;
    ...
    public static final Color YELLOW_GREEN = yellowGreen;
    public static final Color darkOliveGreen = new Color(85, 107, 47);
    public static final Color DARK_OLIVE_GREEN = darkOliveGreen;
    public static final Color oliveDrab = new Color(107, 142, 35);
    public static final Color OLIVE_DRAB = oliveDrab;
    public static final Color lawnGreen = new Color(124, 252, 0);
    public static final Color LAWN_GREEN = lawnGreen;
    ...
    public static final Color DARK_VIOLET = darkViolet;
    public static final Color darkOrchid = new Color(153, 50, 204);
    public static final Color DARK_ORCHID = darkOrchid;
    public static final Color mediumOrchid = new Color(186, 85, 211);
    public static final Color MEDIUM_ORCHID = mediumOrchid;
    ...
    public static final Color MEDIUM_VIOLET_RED = mediumVioletRed;
    public static final Color paleVioletRed = new Color(219, 112, 147);
    public static final Color PALE_VIOLET_RED = paleVioletRed;
    public static final Color deepPink = new Color(255, 20, 147);
    public static final Color DEEP_PINK = deepPink;
    public static final Color hotPink = new Color(255, 105, 180);
    public static final Color HOT_PINK = hotPink;
    public static final Color lightPink = new Color(255, 182, 193);
    public static final Color LIGHT_PINK = lightPink;
    public static final Color antiqueWhite = new Color(250, 235, 215);
    public static final Color ANTIQUE_WHITE = antiqueWhite;
    ...
    public static final Color BLANCHED_ALMOND = blanchedAlmond;
    ...
    public static final Color CORN_SILK = cornSilk;
    public static final Color lemonChiffon = new Color(255, 250, 205);
    public static final Color LEMON_CHIFFON = lemonChiffon;
    public static final Color lightGoldenRodYellow = new Color(250, 250, 210);
    public static final Color LIGHT_GOLDEN_ROD_YELLOW = lightGoldenRodYellow;
    ...
    public static final Color SADDLE_BROWN = saddleBrown;
    ...
    public static final Color NAVAJO_WHITE = navajoWhite;
    public static final Color peachPuff = new Color(255, 218, 185);
    public static final Color PEACH_PUFF = peachPuff;
    public static final Color mistyRose = new Color(255, 228, 225);
    public static final Color MISTY_ROSE = mistyRose;
    public static final Color lavenderBlush = new Color(255, 240, 245);
    public static final Color LAVENDER_BLUSH = lavenderBlush;
    ...
    public static final Color FLORAL_WHITE = floralWhite;
    public static final Color aliceBlue = new Color(240, 248, 255);
    public static final Color ALICE_BLUE = aliceBlue;
    public static final Color ghostWhite = new Color(248, 248, 255);
    public static final Color GHOST_WHITE = ghostWhite;
    ...
    public static final Color DIM_GRAY = dimGray;
